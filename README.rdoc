...
The flowplace is a is a tool for individuals, communities and organizations to build wealth together by using free currencies.
...
The flowplace is released under the LGPL license.
