Feature: mutual credit currency
  ...
  Scenario: Joe makes a trade with Jane
    ...
    And I should see "Plays: 1"
    When I follow "Pay"
    And I select "Joe User's LETS member account" from "play_to"
    And I fill in "play_amount" with "98"
    And I fill in "play_memo" with "car ride"
    And I press "Record Play"
    When I go to the holoptiview page
    Then I should see "Total plays: 2"
    Then I should see "Average plays/member: 1"
    Then I should see "Mass: 2"
